...
import numpy as np 
#example of how to code a sports analyzer
# change the api to current date
...
# request data from a different api 
...
# create a list of all the players for each team
for team in teams:
    players = team["roster"]
    ...
    # predict the stats for each player in the team
