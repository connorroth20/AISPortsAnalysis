...
class cbbDataset(Dataset):
    ...
    def __init__(self, split='train', shuffle=True):
        ...
        X = data.loc[:, ['G','W','ADJOE','ADJDE','BARTHAG','EFG_O','EFG_D','TOR','TORD','ORB','DRB','FTR','FTRD','2P_O','2P_D','3P_O','3P_D','ADJ_T','WAB','SEED']].values
